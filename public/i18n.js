...
const T = {
  es: {
    ...
    'audio.blocked': 'Toca la pantalla para activar el audio',
    'voice.fast': 'Voz rápida',
    'voice.natural': 'Voz natural',
    'voice.help': 'Rápida: lee la traducción al instante con la voz del navegador. Natural: la voz del modelo, más fiel pero con retraso.',
    ...
    'server.closing_soon': 'La sala termina en unos minutos.',
    'server.extended': 'La sala se amplió.',
    'home.enter': 'Entrar',
  ...
  pt: {
    ...
    'audio.blocked': 'Toque na tela para ativar o áudio',
    'voice.fast': 'Voz rápida',
    'voice.natural': 'Voz natural',
    'voice.help': 'Rápida: lê a tradução na hora com a voz do navegador. Natural: a voz do modelo, mais fiel mas com atraso.',
    'net.connecting': 'Conectando…',
    ...
    'server.closing_soon': 'A sala termina em alguns minutos.',
    'server.extended': 'A sala foi ampliada.',
    'home.enter': 'Entrar',
  ...
  en: {
    ...
    'audio.blocked': 'Tap the screen to enable audio',
    'voice.fast': 'Fast voice',
    'voice.natural': 'Natural voice',
    'voice.help': 'Fast: reads the translation instantly with the browser voice. Natural: the model voice, truer but delayed.',
    ...
    'server.closing_soon': 'The room ends in a few minutes.',
    'server.extended': 'The room was extended.',
    'home.enter': 'Join',
